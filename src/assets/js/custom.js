...
function init_plugins() {
  ...
  $(function () {
    ...
    $(".nav-toggler, .sidebartoggler").click(function () {
      ...
      $(".nav-toggler i").toggleClass("aosp-ui-bars-menu");
      if($(".show-sidebar").length){
        $(".nav-toggler i").addClass("aosp-ui-close-menu");
      } else {
        $(".nav-toggler i").removeClass("aosp-ui-close-menu");
      }
    });
    ...
    var set = function () {
      ...
      var width = (window.innerWidth > 0) ? window.innerWidth : screenWidth;
      var topOffset = 0;
      if (width < 1170) {
        $("body").addClass("mini-sidebar");
        $('.navbar-brand span').hide();
        $(".sidebartoggler i").addClass("aosp-ui-bars-menu");
      } else {
        $("body").removeClass("mini-sidebar");
        $('.navbar-brand span').show();
      }

      var screenHeight = window.innerHeighth;
      if (this.screen) {
        screenHeight = this.screen.height;
      }

      var height = ((window.innerHeight > 0) ? window.innerHeight : screenHeight) - 1;
